...
const FEATURES = [
  {
    icon: MdHd,
    title: 'HD & 4K',
    desc: 'Calidad de imagen excepcional en todos tus dispositivos.',
  },
  {
    icon: MdDevices,
    title: 'Multidispositivo',
    desc: 'Mira en tu teléfono, tablet, laptop o TV sin interrupciones.',
  },
  {
    icon: MdDownload,
    title: 'Sin anuncios',
    desc: 'Disfruta tu contenido favorito sin interrupciones.',
  },
  {
    icon: MdFamilyRestroom,
    title: 'Para toda la familia',
    desc: 'Contenido para todas las edades en un solo lugar.',
  },
  {
    icon: MdStar,
    title: 'Lo mejor del cine',
    desc: 'Películas y series seleccionadas de todo el mundo.',
  },
  {
    icon: MdPlayCircle,
    title: 'Siempre disponible',
    desc: 'Accede cuando quieras, donde quieras, 24/7.',
  },
]
...
const FAQS = [
  {
    q: '¿Qué es StreamVox?',
    a: 'StreamVox es una plataforma de streaming donde puedes ver películas y series en cualquier momento y desde cualquier dispositivo.',
  },
  {
    q: '¿Cómo creo mi cuenta?',
    a: 'Haz clic en "Comenzar gratis", elige tu método de registro (email o Google) y en segundos tendrás acceso a todo el catálogo.',
  },
  {
    q: '¿Puedo ver contenido sin conexión?',
    a: 'StreamVox es una PWA instalable. Puedes instalarla en tu dispositivo para un acceso más rápido, aunque el streaming requiere conexión.',
  },
  {
    q: '¿En qué dispositivos puedo verlo?',
    a: 'En cualquier dispositivo con navegador moderno: teléfonos, tablets, laptops y computadoras de escritorio.',
  },
]
    ...
    <div className="min-h-screen bg-dark-950 text-white overflow-x-hidden">
        ...
        <div className="max-w-screen-xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="text-sm text-dark-200 hover:text-white transition-colors px-4 py-2"
            >
              {t('signIn')}
            </button>
            <button
      ...
      <section className="relative min-h-screen flex items-center justify-center px-6 pt-16">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none select-none">
          {[
            { top: '15%', left:  '3%',  rotate: '-8deg',  opacity: 0.18, delay: '0s'   },
            { top: '55%', left:  '2%',  rotate: '-4deg',  opacity: 0.12, delay: '0.3s' },
            { top: '20%', right: '4%',  rotate:  '7deg',  opacity: 0.18, delay: '0.1s' },
            { top: '60%', right: '2%',  rotate:  '5deg',  opacity: 0.12, delay: '0.4s' },
            { top: '38%', left:  '10%', rotate: '-6deg',  opacity: 0.10, delay: '0.2s' },
            { top: '35%', right: '8%',  rotate:  '6deg',  opacity: 0.10, delay: '0.5s' },
          ].map((style, i) => (
            <div
              key={i}
              className="absolute w-24 sm:w-32 aspect-[2/3] rounded-xl bg-gradient-to-br from-dark-700 to-dark-800 border border-dark-600 shadow-2xl"
              style={{
                top: style.top, left: style.left, right: style.right,
                transform: `rotate(${style.rotate})`,
                opacity: style.opacity,
                animation: `fadeIn 1s ${style.delay} both`,
              }}
            />
          ))}
        </div>
        ...
        <div className="relative z-10 text-center max-w-3xl mx-auto">
          ...
          <h1 className="font-display text-6xl sm:text-8xl lg:text-9xl tracking-wide leading-none mb-6">
            ...
            <span className="text-brand-500">VOX</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <button
              onClick={() => navigate('/auth?mode=login')}
              className="btn-ghost text-base px-8 py-4 rounded-xl w-full sm:w-auto"
            >
              Ya tengo cuenta
            </button>
          </div>
        ...
        <div className="max-w-screen-xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="font-display text-4xl sm:text-5xl tracking-wider mb-4">
              TODO LO QUE <span className="text-brand-500">NECESITAS</span>
            </h2>
            <p className="text-dark-300 max-w-md mx-auto">
              Una experiencia de streaming completa, rápida y sin complicaciones.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {FEATURES.map(({ icon: Icon, title, desc }) => (
              <div
                key={title}
                className="bg-dark-800/60 border border-dark-700 hover:border-brand-600/40 rounded-2xl p-6 transition-all duration-300 hover:-translate-y-1 group"
              >
          ...
          <div className="relative bg-gradient-to-r from-brand-600/20 via-dark-800 to-dark-800 border border-brand-600/25 rounded-3xl p-10 sm:p-16 overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col sm:flex-row items-center gap-8 justify-between">
              <div className="max-w-lg">
                <h2 className="font-display text-4xl sm:text-5xl tracking-wider mb-4 leading-tight">
                  EMPIEZA A VER <span className="text-brand-500">HOY MISMO</span>
                </h2>
                <p className="text-dark-200 leading-relaxed">
                  Crea tu cuenta en segundos y accede a todo el catálogo de películas y series. Sin límites, sin esperas.
                </p>
              </div>
              <button
                onClick={() => navigate('/auth?mode=register')}
      ...
      <section className="py-24 px-6">
        <div className="max-w-2xl mx-auto">
          <h2 className="font-display text-4xl tracking-wider text-center mb-12">
          ...
          <div className="space-y-4">
            {FAQS.map(({ q, a }) => (
              <details
                key={q}
                className="group bg-dark-800 border border-dark-600 hover:border-dark-500 rounded-2xl overflow-hidden transition-colors"
              >
                ...
                <p className="px-6 pb-5 text-dark-300 text-sm leading-relaxed border-t border-dark-700 pt-4">
                  {a}
                </p>
              </details>
            ))}
      ...
      <footer className="border-t border-dark-800 py-10 px-6">
        <div className="max-w-screen-xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-dark-500 text-sm">
            © {new Date().getFullYear()} StreamVox. Todos los derechos reservados.
          </p>
